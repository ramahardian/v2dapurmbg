  ...
  const stepsFinance = [
    {
      ...
      desc: '<strong class="text-blue-700">Fitur Baru!</strong> Hasil perencanaan kebutuhan dari siklus bisa langsung diubah menjadi Draft Purchase Request (PR). Cukup panggil API: <code class="text-xs bg-stone-100 px-1.5 py-0.5 rounded">POST /api/purchase_order/create-pr-from-siklus</code> dengan body <code class="text-xs bg-stone-100 px-1.5 py-0.5 rounded">{ siklus_ids: [...], jumlah_penerima: Number }</code>. PR akan otomatis terbuat dengan status Draft, siap untuk ditinjau oleh bagian Keuangan.',
      link: null
    },
    {
