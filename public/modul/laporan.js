...
const tabColors = {
  ...
  try {
    if (tab === 'persediaan') {
      ...
      // ── Tambah tabel RAB Harian di bawah ──
      try {
        ...
        if (items.length > 0) {
          var no = 0;
          var tabelHtml = '<div class="mt-6 bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">' +
          ...
          window._lapStatCards += tabelHtml;
        }
      } catch(e) {}
