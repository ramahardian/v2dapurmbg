...
function saveGridPicker(hk, rk) {
  ...
  var items = hkKeys.map(function(hk) {
    ...
    return { hari_ke: d.hari_ke, hari_nama: d.hari_nama, menu_id: d.menu_id || '', menu_nama: d.menu_nama || '', jumlah_porsi: meta.jumlah_porsi || 0 };
  });
