    ...
    <tbody>
      ${rows.map(r => {
        ...
        return `<tr class="border-t border-stone-100">
          ...
          <td class="px-4 py-3 text-center whitespace-nowrap">
            <button onclick="openPembelianForm(${JSON.stringify(r).replace(/'/g, "&#39;")})" class="text-stone-500 hover:text-stone-900 p-1.5 inline-flex items-center" title="Edit">
            ...
            <button onclick="kirimKeKoperasi(${JSON.stringify(r).replace(/'/g, "&#39;")})" class="text-emerald-600 hover:text-emerald-800 p-1.5 inline-flex items-center" title="Kirim ke Koperasi">
