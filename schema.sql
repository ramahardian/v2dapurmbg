...
CREATE TABLE IF NOT EXISTS menu (
  ...
  gramasi_kecil DECIMAL(10,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS budget (
  ...
  harga_besar DECIMAL(15,2) DEFAULT 0,
  harga_kecil DECIMAL(15,2) DEFAULT 0,
...
(1, 'Ibu Hamil', 'Karbohidrat', 2.5),
(1, 'Ibu Hamil', 'Protein Hewani', 2),
(1, 'Ibu Hamil', 'Protein Nabati', 1),
(1, 'Ibu Hamil', 'Sayur', 1),
(1, 'Ibu Hamil', 'Buah', 1),
(1, 'Ibu Hamil', 'Susu', 1),
(1, 'Ibu Hamil', 'Minyak', 1.5),
(1, 'Ibu Menyusui', 'Karbohidrat', 2.5),
(1, 'Ibu Menyusui', 'Protein Hewani', 2),
(1, 'Ibu Menyusui', 'Protein Nabati', 1),
(1, 'Ibu Menyusui', 'Sayur', 1),
(1, 'Ibu Menyusui', 'Buah', 1),
(1, 'Ibu Menyusui', 'Susu', 1),
(1, 'Ibu Menyusui', 'Minyak', 1.5),
(1, 'Balita', 'Karbohidrat', 0.8),
(1, 'Balita', 'Protein Hewani', 1),
(1, 'Balita', 'Protein Nabati', 0.25),
(1, 'Balita', 'Sayur', 0.25),
(1, 'Balita', 'Buah', 1),
(1, 'Balita', 'Susu', 1),
(1, 'Balita', 'Minyak', 1),
(1, 'TK/PAUD', 'Karbohidrat', 0.8),
(1, 'TK/PAUD', 'Protein Hewani', 1),
(1, 'TK/PAUD', 'Protein Nabati', 0.25),
(1, 'TK/PAUD', 'Sayur', 0.25),
(1, 'TK/PAUD', 'Buah', 1),
(1, 'TK/PAUD', 'Susu', 1),
(1, 'TK/PAUD', 'Minyak', 1),
(1, 'SD 1-3', 'Karbohidrat', 1),
(1, 'SD 1-3', 'Protein Hewani', 1),
(1, 'SD 1-3', 'Protein Nabati', 0.25),
(1, 'SD 1-3', 'Sayur', 0.25),
(1, 'SD 1-3', 'Buah', 1),
(1, 'SD 1-3', 'Susu', 1),
(1, 'SD 1-3', 'Minyak', 1),
(1, 'SD 4-6', 'Karbohidrat', 1.75),
(1, 'SD 4-6', 'Protein Hewani', 1.5),
(1, 'SD 4-6', 'Protein Nabati', 0.5),
(1, 'SD 4-6', 'Sayur', 0.5),
(1, 'SD 4-6', 'Buah', 1),
(1, 'SD 4-6', 'Susu', 1),
(1, 'SD 4-6', 'Minyak', 1.5),
(1, 'SMP', 'Karbohidrat', 2),
(1, 'SMP', 'Protein Hewani', 1.5),
(1, 'SMP', 'Protein Nabati', 1),
(1, 'SMP', 'Sayur', 0.5),
(1, 'SMP', 'Buah', 1),
(1, 'SMP', 'Susu', 1),
(1, 'SMP', 'Minyak', 1.5),
(1, 'SMA', 'Karbohidrat', 2),
(1, 'SMA', 'Protein Hewani', 2),
(1, 'SMA', 'Protein Nabati', 1),
(1, 'SMA', 'Sayur', 1),
(1, 'SMA', 'Buah', 1),
(1, 'SMA', 'Susu', 1),
(1, 'SMA', 'Minyak', 1.5)
