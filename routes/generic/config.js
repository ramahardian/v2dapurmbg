 ...
 */
const TABLES = {
  penerima_manfaat: ['nama_kelompok', 'paket_besar', 'paket_besar_utama', 'paket_kecil', 'sample', 'guru_tendik', 'lokasi', 'keterangan', 'kategori_penerima', 'provinsi', 'kota', 'kecamatan', 'nomor_telepon', 'nama_kontak', 'email', 'status_kepemilikan'],
  bahan_baku: ['kode', 'nama', 'kategori', 'kategori_sp', 'berat_1_sp', 'persen_bdd', 'berat_per_satuan', 'satuan', 'harga_satuan', 'harga_sebelumnya', 'stok_saat_ini', 'stok_minimum', 'buffer_persen', 'sumber', 'kalori', 'protein', 'karbohidrat', 'lemak', 'serat'],
